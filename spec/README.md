...
| 14 | [Per-Prompt Inference Settings](14-per-prompt-inference-settings.md) | Typed generation settings and effective-setting snapshots for result prompts | Draft |
