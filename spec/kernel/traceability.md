...
| REQ-STT-004 | `MacParakeetCore/SpeechEnginePreference.swift`, `MacParakeetCore/NemotronLanguageCatalog.swift`, `MacParakeetCore/STT/NemotronEngine.swift`, `MacParakeetCore/STT/STTRuntime.swift`, `MacParakeetCore/Services/AppPaths.swift`, `MacParakeetCore/Services/Telemetry/TelemetryEvent.swift`, `MacParakeetCore/AppFeatures.swift`, `CLI/Commands/TranscribeCommand.swift`, `CLI/Commands/ModelsCommand.swift`, `CLI/Commands/ConfigCommand.swift`, `MacParakeetViewModels/SettingsViewModel.swift`, `MacParakeet/Views/Settings/SettingsView.swift`, `Package.swift` | `NemotronEngineTests.swift`, `NemotronLanguageCatalogTests.swift`, `SpeechEnginePreferenceTests.swift`, `TranscribeCommandTests.swift`, `ModelLifecycleCommandTests.swift`, `ConfigCommandTests.swift`, `SettingsViewModelTests.swift`, `TelemetryServiceTests.swift` |
