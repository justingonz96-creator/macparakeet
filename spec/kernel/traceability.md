...
| Requirement | Source Files | Test Files |
|------------|-------------|------------|
| REQ-CMD-001 | `MacParakeetCore/Services/CommandMode/CommandModeRouter.swift`, `MacParakeetCore/Services/CommandMode/CommandModePrompts.swift`, `MacParakeetCore/Services/CommandMode/CommandModeExecutor.swift`, `MacParakeetCore/Services/CommandMode/MicrophoneArbiter.swift`, `MacParakeetCore/Services/System/SelectionCaptureService.swift`, `MacParakeetCore/Services/System/SelectionReplacementService.swift`, `MacParakeetCore/Services/Telemetry/TelemetryEvent.swift`, `MacParakeet/Hotkey/CommandModeHotkeyMonitor.swift`, `MacParakeet/App/CommandModeCoordinator.swift`, `MacParakeet/Views/Transforms/TransformSpikeProgressPanelController.swift`, `MacParakeetViewModels/SettingsViewModel.swift`, `MacParakeet/Views/Settings/SettingsView.swift`, `MacParakeetCore/AppFeatures.swift` | `Services/CommandMode/CommandModeRouterTests.swift`, `Services/CommandMode/CommandModePromptsTests.swift`, `Services/CommandMode/CommandModeExecutorTests.swift`, `Services/CommandMode/MicrophoneArbiterTests.swift`, `Hotkey/CommandModeHotkeyMonitorTests.swift`, `ViewModels/SettingsViewModelCommandModeTests.swift`, `TelemetryServiceTests.swift` |
| REQ-CMD-002 | `MacParakeetCore/Services/CommandMode/CommandModeRouter.swift`, `MacParakeetCore/Services/CommandMode/DeterministicTextEdit.swift`, `MacParakeetCore/Services/CommandMode/CommandModeExecutor.swift`, `MacParakeetCore/Services/System/SelectionReplacementService.swift` | `Services/CommandMode/CommandModeRouterTests.swift`, `Services/CommandMode/DeterministicTextEditTests.swift`, `Services/CommandMode/SelectionDeletionTests.swift`, `Services/CommandMode/CommandModeExecutorTests.swift` |
