...
/// Merges Parakeet token-level timings into word-level `TimestampedWord`s.
///
/// Shared by the batch path (`STTRuntime`) and the streaming path
/// (`FluidStreamingDictationEngine`, ADR-023): both receive FluidAudio
/// `TokenTiming`s where a leading "▁" (U+2581) marks a word boundary.
enum ParakeetTokenTimingMerger {
    static func merge(_ tokenTimings: [TokenTiming]?) -> [TimestampedWord] {
