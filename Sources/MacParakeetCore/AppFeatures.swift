...
public enum AppFeatures {
    ...
    /// Upstream enabled this after the post-#318 reliability hardening
    /// (ADR-017 Phases 1+2): mid-flight teardown, RSVP/zero-duration guards,
    /// and reschedule re-fire. Calendar-driven auto-stop was removed by the
    /// 2026-05 amendment.
    /// This fork keeps it `false` pending hands-on E2E validation against real
    /// calendars; flip to `true` in a point release once that is done.
