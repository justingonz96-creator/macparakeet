...
| ADR-023 | Nemotron as an optional European-language STT engine (built but disabled behind `AppFeatures.nemotronEnabled = false`) | `spec/adr/023-nemotron-european-stt.md` |
