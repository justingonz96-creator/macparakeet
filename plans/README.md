...
|------|-------|--------|----------|-------------|
| [2026-09-05-post-meeting-notes-and-prompt-context](active/2026-09-05-post-meeting-notes-and-prompt-context.md) | Post-meeting notes, opt-in prompt context, and rich Markdown follow-up | **PARTIAL** | P2 | Saved-note editing, prompt checkbox, exact LLM snapshots, CLI/artifacts, docs, and local verification are complete in branch. Rich Markdown tables/task lists remain PROPOSED and need explicit approval before implementation. |
