...
|------|-------|--------|----------|-------------|
| [2026-09-05-post-meeting-notes-and-prompt-context](active/2026-09-05-post-meeting-notes-and-prompt-context.md) | Post-meeting notes, opt-in prompt context, and rich Markdown follow-up | **IMPLEMENTED — VISUAL QA FOUND BLOCKERS** | P2 | Saved meetings now separate the always-editable, autosaved Notes tab from Transcript. Real-app QA passed saved-note editing, completed Prompt Results, saved Chat, light/dark rendering, rich blocks, and task-state accessibility. Before PR/release: fix direct table-cell selection and the unlabeled table Download action, then run streaming/live Ask, keyboard-link, 360 px, and release-size gates. |
...
| [2026-09-05-versioned-prompt-manager-meeting-classification](completed/2026-09-05-versioned-prompt-manager-meeting-classification.md) | Versioned Prompt Manager and meeting classification | **COMPLETED** | P1/P2 | Implemented and verified 2026-09-05: immutable prompt versions, Markdown editing/diff, uniform built-in CRUD, prompt collections, meeting types/labels, and type-aware prompt availability/auto-run. |
