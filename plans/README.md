...
| [2026-09-05-speaker-attribution-editing](active/2026-09-05-speaker-attribution-editing.md) | Speaker attribution editing and speaker management (#542, #900, #893 slice) | **PROPOSED** | P1 | Product approval on five bounded decisions, then Phase 0: automatic/effective attribution contract, correction payload/fingerprint, and resolver parity tests. V1 covers assign/add/merge/remove, explicit between-word segment split, split-selected-to-speaker, persistent undo, and the shipped exact-speaker-count constraint in retranscription UX; no text editing, live diarization, or voiceprints. |
